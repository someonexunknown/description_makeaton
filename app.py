...
def generate_description(item, location, occasion):
    ...
    "the hashtags should feel like a natural extension of what was just said, not separately brainstormed tags.\n"
    ...
    "6. Return ONLY the post text with hashtags at the end, no extra explanation or formatting.\n\n"
